# Сбор данных с сайтов и обработка текста
Необходимо на любом интересующем сайте собрать свой собственный датасет и натренировать на нём модель. При сборе данных с сайта предстоит обойти все ловушки серверов и пробраться сквозь html-код страницы. Датасет должен иметь текстовое описание некоторого объекта и некоторую целевую переменную, соответствующую этому объекту.
